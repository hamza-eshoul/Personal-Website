        ...
        <div className="flex gap-14 font-medium">
          {language == "French" && (
            <section className="fade-in-animation w-1/2 text-justify text-[20px] font-normal leading-7">
              <p>
                J'ai appris le développement Web avec le{" "}
                <a
                ...
                nécessaires pour créer des applications web modernes et
                complètes.
              </p>
              ...
              <p className="pt-4">
                Je me spécialise dans l'utilisation de la bibliothèque
                JavaScript,{" "}
